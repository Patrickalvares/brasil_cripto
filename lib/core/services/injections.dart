...
void setupInjections() {
  ...
  i.registerLazySingleton<CoinDataSource>(
    () => CoinDataSourceImpl(i<ApiService>()));
  ...
  // ViewModels  
  i.registerFactory<MarketViewModel>(
    () => MarketViewModel(i<CoinRepository>()));
    
  i.registerFactory<CoinDetailViewModel>(
    () => CoinDetailViewModel(i<CoinRepository>()));
    
  i.registerFactory<FavoritesViewModel>(
    () => FavoritesViewModel(i<CoinRepository>()));
    
  i.registerFactory<SearchViewModel>(
    () => SearchViewModel(i<CoinRepository>()));
} 
